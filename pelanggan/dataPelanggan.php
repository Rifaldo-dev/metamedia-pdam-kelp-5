<?php
$pageTitle = "Data Pelanggan - PDAM Zernih";
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="tambahPelanggan.php" class="btn btn-primary btn-sm">
                            <i class="fas fa-plus"></i> Tambah Pelanggan
                        </a>
                        <div class="form-inline">
                            <div class="input-group input-group-sm">
                                <input type="text" id="liveSearch" class="form-control" placeholder="Cari..." value="<?= htmlspecialchars($search) ?>" data-type="pelanggan">
                        ...
                        <tbody id="tableBody">
                            <?php if (mysqli_num_rows($result) > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="editPelanggan.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="hapusPelanggan.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus data ini?')">
